...
## Project Structure
    ...
    ├── online_shopping_tem_38028  # Django project configurations
...
1. Clone this repo and `cd online_shopping_tem_38028`
...
2. Clone this repo and `cd online_shopping_tem_38028`
